...
$sql ="SELECT * FROM myteam WHERE useremail=:email AND temp=1";
        ...
        <div class="footer row p-0 mx-auto jumbotron jumbo-color mt-1">
            ...
            <div class="col-12">
                ...
                <div class="row mx-auto mb-3 pt-2 p-2 rounded">
                    ...
                    <!--            class="btn  block-f btn-danger rounded pt-1 pb-1">SUBMIT</button></a>-->
                    <!--</div>-->
                    
                    <div class="col-6 col-md-4 mx-auto">
                        <a href="myteam.php">
                            <button style="outline:none; border:none;"
                                class="btn  block-f btn-danger rounded pt-1 pb-1">View My Team</button></a>
                    </div>

                    <div class="col-6 col-md-4 mx-auto"><button type="submit" onclick="saveteam()"
                            style="outline:none; border:none;" name="myteam"
                            class="btn btn-success block rounded pt-1 pb-1">SAVE</form></button> </div>
